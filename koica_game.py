...
플레이어는 KOICA 해외사무소장으로서 수원국에서 대한민국 ODA 사업을 총괄하고 있습니다.

## KOICA 해외사무소와 사무소장의 역할
- ODA 사업 발굴 및 관리 (신규 사업 기획, 프로젝트 집행, 모니터링 및 평가)
- 대외 협력 및 파트너십 구축 (수원국 정부, UN 등 국제기구, 타 원조기관, NGO, 민간 기업)
- 현지 인력 및 행정 지원 (봉사단원, 전문가, 자문관 관리, 행정/회계/자산 관리, 홍보)
- KOICA 대표 기능 (외교관 준하는 지위로 고위급 인사 면담)
- 전략 수립 및 의사결정 (국가협력전략 CP 수립, 중장기 지원 전략)
...
플레이어는 KOICA 해외사무소장으로서 수원국에서 대한민국 ODA 사업을 총괄하는 책임자입니다.
플레이어가 자유롭게 입력한 행동에 대해 결과를 판정하고 스탯 변화를 계산하세요.

## KOICA 해외사무소장의 역할과 권한
- ODA 사업 발굴, 집행, 모니터링 총괄
- 수원국 정부, UN, 국제기구와의 외교적 협력
- 봉사단원, 전문가, 파견 직원의 안전과 복무 관리
- 사무소 예산 및 자산 관리 책임
- 국가협력전략 수립의 핵심 역할
...
class KOICAGame:
    ...
    def display_intro(self):
        ...
        print("\n해외사무소는 대한민국 ODA 사업의 최일선 현장 기지입니다.")
        print("사무소장으로서 당신은:")
        print("  • 수원국에서 KOICA를 대표하는 총괄 책임자")
        print("  • ODA 사업 발굴, 집행, 모니터링을 총괄")
        print("  • 수원국 정부, UN, 국제기구와 협력 관계 구축")
        print("  • 봉사단원, 전문가, 파견 직원 관리")
        print("  • 국가협력전략(CP) 수립의 핵심 역할")
