...
**본부 (HQ)**:
- 외교부 등으로부터 전체 예산을 확보
- 사업 계획과 전략에 따라 각 국가별, 사업별 예산을 편성
- 이 예산을 각 해외사무소에 배정(할당)
- 전체적인 '예산집행지침' 마련 및 예산 이월 등 중요 변경사항 최종 승인

**해외사무소 (Offices)**:
- 본부로부터 배정받은 예산 한도 내에서만 사업 운영 및 예산 집행
...
- 사무소는 기존 예산 재배분, 사업 축소/확대, 본부에 추가 예산 요청만 가능
- 사무소장의 예산 관련 딜레마는 "한정된 예산을 어떻게 배분할 것인가"여야 함
...
## KOICA 예산 구조 (중요!)
**본부**: 전체 예산 확보 및 각 해외사무소에 배정
**해외사무소**: 본부로부터 배정받은 예산 한도 내에서만 집행
**중요**: 해외사무소는 자체적으로 예산을 늘릴 수 없음. 본부에 추가 예산 요청만 가능.
